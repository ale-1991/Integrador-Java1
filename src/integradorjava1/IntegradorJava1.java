...
public class IntegradorJava1 {
    ...
    public static void main(String[] args) {
        ...
        EstudiantesServicio serv = new EstudiantesServicio();
        serv.crearEstudiantes(estudiantes);
        serv.mostrarEstudiantes(estudiantes);
        System.out.println("el promedio de las notas del curso es: "+serv.mostrarPromedio(estudiantes));
        String nombresAlumnos[];
        nombresAlumnos = serv.alumnosMayorPromedio(estudiantes);
        serv.mostrarAlumnosMayorPromedio(estudiantes);
    }
